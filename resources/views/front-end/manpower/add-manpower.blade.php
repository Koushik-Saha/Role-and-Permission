...
@section('title', 'Add New Manpower')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Create New Manpower</h4>
                    </div>
                    <form class="form form-vertical" novalidate action="{{route('add-manpower')}}"
                          method="post"
                            ...
                            <div class="card-body">
                                <form class="form-horizontal">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="note">Designation: </label>
