<body
  class="horizontal-layout horizontal-menu navbar-floating dark-layout {{ $configData['blankPageClass'] }} {{ $configData['bodyClass'] }}  {{($configData['theme'] === 'light') ? '' : $configData['theme'] }} {{ $configData['sidebarClass'] }} {{ $configData['footerType'] }}  footer-light"
