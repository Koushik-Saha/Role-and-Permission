            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  ...
                  <p>Use data attribute <code>data-icon</code> to add icon name for each options. And use class <code>.select2-icons</code>
                    to set icon with option.</p>
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  ...
                  <p>Select2 multi-value select boxes can set restrictions regarding the maximum number of options
                    selected. The select below is declared with the <code>multiple</code> attribute with <code>maximumSelectionLength</code>
              ...
              <div class="row">
                <div class="col-sm-6 col-12">
                  ...
                  <p>Select2 provides a way to load the data from a local array. You can provide initial selections with
                    array data by providing the option tag for the selected values, similar to how it would be done for
                    a standard select.</p>
                  <div class="form-group">
                ...
                <div class="col-sm-6 col-12">
                  ...
                  <p>Select2 comes with AJAX support built in, using jQuery's AJAX methods. In this example, we can
                    search for repositories using GitHub's API.</p>
                  <div class="form-group">
        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <p>For different sizes of select2, Use classes like <code>.select2-size-sm</code> &amp; <code>.select2-size-lg</code>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-bg</code> with <code>data-bgcolor</code> &amp; <code>data-bgcolor-variation</code>
                    attributes for background color of control.</p>
                  <div class="form-group">
                ...
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-full-bg</code> with <code>data-bgcolor</code> &amp; <code>data-bgcolor-variation</code>
                    attributes for full select2 control background color.</p>
                  <div class="form-group">
                    <select class="select2-full-bg form-control" id="full-bg-select" data-bgcolor="info"
                            data-bgcolor-variation="lighten-3" data-text-color="white">
                      <optgroup label="Figures">
                        <option value="romboid">Romboid</option>
                        <option value="trapeze">Trapeze</option>
                ...
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-border</code> with <code>data-border-color</code> &amp; <code>data-border-variation</code>
                    attributes class for Border color of control.</p>
                  <div class="form-group">
                    <select class="select2-border border-warning form-control" id="border-select"
                            data-border-color="warning" data-border-variation="darken-2" data-text-color="warning"
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-bg</code> with <code>data-bgcolor</code> &amp; <code>data-bgcolor-variation</code>
                    attributes for background color of control.</p>
                  <div class="form-group">
                    <select class="select2-bg form-control" multiple="multiple" id="bg-select-multi"
                            data-bgcolor="success" data-bgcolor-variation="lighten-3" data-text-color="white">
                      <optgroup label="Figures">
                        <option value="romboid">Romboid</option>
                        <option value="trapeze" selected>Trapeze</option>
                        <option value="triangle">Triangle</option>
                ...
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-full-bg</code> with <code>data-bgcolor</code> &amp; <code>data-bgcolor-variation</code>
                    attributes for full select2 control background color.</p>
                  <div class="form-group">
                    <select class="select2-full-bg form-control" multiple="multiple" id="full-bg-select-multi"
                            data-bgcolor="info" data-bgcolor-variation="lighten-3" data-text-color="white">
                      <optgroup label="Figures">
                        <option value="romboid">Romboid</option>
                        <option value="trapeze">Trapeze</option>
                        <option value="triangle">Triangle</option>
                ...
                <div class="col-12">
                  ...
                  <p>Use class <code>.select2-border</code> with <code>data-border-color</code> &amp; <code>data-border-variation</code>
                    attributes class for Border color of control.</p>
                  <div class="form-group">
                    <select class="select2-border border-warning form-control" multiple="multiple"
                            id="border-select-multi" data-border-color="warning" data-border-variation="darken-2"
